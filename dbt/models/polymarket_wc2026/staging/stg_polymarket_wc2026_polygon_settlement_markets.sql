...
select  -- noqa: ST06
    ...
    lower(cast(reference_bundle_id as varchar)) as reference_bundle_id,
    cast(reference_table as varchar) as reference_table,
    cast(reference_row_key as varchar) as reference_row_key,
    lower(cast(reference_row_sha256 as varchar)) as reference_row_sha256,
