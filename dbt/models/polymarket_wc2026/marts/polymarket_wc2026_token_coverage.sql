with daily_agg as (
    ...
    from {{ ref('int_polymarket_wc2026_token_daily_timeseries') }}
...
market_health as (
    ...
    left join {{ ref('stg_polymarket_wc2026_sync_ledger') }} as l
...
left join {{ ref('stg_polymarket_wc2026_sync_ledger') }} as l
    on t.clob_token_id = l.clob_token_id
left join {{ ref('stg_polymarket_wc2026_token_sync_skips') }} as s
