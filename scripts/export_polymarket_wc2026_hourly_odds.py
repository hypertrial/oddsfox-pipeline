#!/usr/bin/env python3
"""
Export the WC2026 hourly odds mart to a parquet file.

Reads ``polymarket_wc2026_marts.polymarket_wc2026_token_hourly_odds`` from the local DuckDB
...
Usage:
  python3 scripts/export_polymarket_wc2026_hourly_odds.py
  python3 scripts/export_polymarket_wc2026_hourly_odds.py --snapshot-copy
  python3 scripts/export_polymarket_wc2026_hourly_odds.py --output /tmp/wc2026_hourly.parquet
"""
...
MART_NAME: Final = "polymarket_wc2026_token_hourly_odds"
PRICE_COLUMNS: Final = (
    "open_price",
    "high_price",
    "low_price",
...
COLUMN_DOCS: Final[dict[str, str]] = {
    ...
    "event_slug": "Polymarket event slug for the WC2026 market scope.",
    ...
    *,
    ...
    lines.extend(
        [
            ...
            "- `outcome_label` resolves Yes/No (or named outcomes) without joining `polymarket_wc2026_markets`.",
...
def export_polymarket_wc2026_hourly_odds_parquet(
    conn: duckdb.DuckDBPyConnection,
    output_path: Path,
    *,
    mart_name: str = MART_NAME,
    ...
    """Export the WC2026 hourly odds mart; return row count and optional spec path."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    p.add_argument(
        ...
        help=(
            ...
            "(default: artifacts/polymarket_wc2026_exports/polymarket_wc2026_token_hourly_odds_<UTC>.parquet)"
        ),
    )
    p.add_argument(
        "--output-dir",
    ...
    if args.snapshot_copy:
        ...
        snap_dir = Path(
            tempfile.mkdtemp(
                prefix="polymarket_wc2026_hourly_export_snap_",
