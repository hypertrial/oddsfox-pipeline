...
Usage:
  python3 scripts/count_polymarket_wc2026_gamma_tag_events.py
  python3 scripts/count_polymarket_wc2026_gamma_tag_events.py --tag 2026-fifa-world-cup
  python3 scripts/count_polymarket_wc2026_gamma_tag_events.py --tag fifa-world-cup --tag 2026-fifa-world-cup
  python3 scripts/count_polymarket_wc2026_gamma_tag_events.py --keyset-closed any
  python3 scripts/count_polymarket_wc2026_gamma_tag_events.py --keyset-volume-min 0
"""
...
def main() -> int:
    default_volume_min = POLYMARKET_WC2026_SCOPE_KEYSET_VOLUME_MIN
    default_volume_help = (
    ...
    parser.add_argument(
        ...
        default=POLYMARKET_WC2026_SCOPE_KEYSET_CLOSED,
