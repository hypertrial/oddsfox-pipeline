...
Reads ``wc2026_polymarket_marts.wc2026_token_hourly_odds`` from the local DuckDB
...
Usage:
  python3 scripts/export_wc2026_hourly_odds.py
  python3 scripts/export_wc2026_hourly_odds.py --snapshot-copy
  python3 scripts/export_wc2026_hourly_odds.py --output /tmp/wc2026_hourly.parquet
"""
...
MART_NAME: Final = "wc2026_token_hourly_odds"
PRICE_COLUMNS: Final = (
    "open_price",
    "high_price",
    "low_price",
...
def main(argv: list[str] | None = None) -> int:
    ...
    p.add_argument(
        ...
        help=(
            ...
            "(default: artifacts/wc2026_exports/wc2026_token_hourly_odds_<UTC>.parquet)"
        ),
    )
    p.add_argument(
        "--output-dir",
    ...
    if args.snapshot_copy:
        ...
        snap_dir = Path(
            tempfile.mkdtemp(
                prefix="wc2026_hourly_export_snap_",
