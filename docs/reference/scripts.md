...
- `export_polymarket_markets.py`: export the public Polymarket market catalog marts (`polymarket_wc2026_markets` and `polymarket_us_midterms_2026_markets`) to parquet under `artifacts/polymarket_markets_exports/`. Use `--scope wc2026` or `--scope us_midterms_2026` for one mart.
