...
- `export_polymarket_wc2026_hourly_odds.py`: export `polymarket_wc2026_marts.polymarket_wc2026_token_hourly_odds` to parquet plus a companion `.md` data spec.
- `export_polymarket_wc2026_knockout_markets.py`: export `polymarket_wc2026_marts.polymarket_wc2026_knockout_token_hourly_odds` to parquet for WC2026 knockout artifact builds.
...
uv run python scripts/export_polymarket_wc2026_hourly_odds.py
uv run python scripts/export_polymarket_wc2026_hourly_odds.py --snapshot-copy --output /tmp/wc2026_hourly.parquet
# writes /tmp/wc2026_hourly.parquet and /tmp/wc2026_hourly.md
uv run python scripts/export_polymarket_wc2026_knockout_markets.py
