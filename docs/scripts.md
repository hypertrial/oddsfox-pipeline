...
- `export_wc2026_knockout_markets.py`: export `polymarket_marts.wc2026_knockout_token_hourly_odds` to parquet for WC2026 knockout artifact builds.
...
# writes artifacts/selected_scope_exports/wc2026_knockout_token_hourly_odds_<UTC>.parquet
```
