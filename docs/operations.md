...
- `polymarket_wc2026_hourly_odds_ingest`: hourly WC2026 token odds refresh.
- `polymarket_wc2026_dbt_build`: dbt analytics build for the WC2026 mart surface, including knockout marts.
- `polymarket_wc2026_full_pipeline`: WC2026 market discovery, hourly odds refresh, and dbt analytics build.
