...
RULES: tuple[Rule, ...] = (
    Rule(
        ...
        allow_path_substrings=(
            "tests/repository/test_naming_policy.py",
            "tests/repository/dbt/test_project_files.py",
        ),
        allow_line_regexes=(
    ...
    Rule(
        ...
        allow_path_substrings=("tests/repository/test_naming_policy.py",),
        allow_line_regexes=(
