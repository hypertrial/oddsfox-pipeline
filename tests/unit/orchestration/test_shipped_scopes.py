...
def test_shipped_scopes_lookup_property_accepts_all_aliases(spec, use_namespace):
...
def test_shipped_scopes_lookup_property_rejects_unknown_aliases(ref):
    with pytest.raises(ValueError, match="Unknown scope"):
        get_scope_spec(ref)


def test_shipped_scopes_rejects_unknown_and_duplicate_aliases():
    with pytest.raises(ValueError, match="Unknown scope"):
