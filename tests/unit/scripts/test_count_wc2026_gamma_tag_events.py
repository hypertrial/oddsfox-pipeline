"""Tests for scripts/count_wc2026_gamma_tag_events.py."""
...
def _load_count_module():
    ...
    return importlib.import_module("count_wc2026_gamma_tag_events")
...
def test_count_main_rejects_invalid_inputs(monkeypatch, args):
    ...
    monkeypatch.setattr(sys, "argv", ["count_wc2026_gamma_tag_events.py", *args])
...
def test_count_main_rejects_empty_tag_resolution(monkeypatch):
    ...
    monkeypatch.setattr(sys, "argv", ["count_wc2026_gamma_tag_events.py"])
