...
_MARKET_COLUMNS = {
    ...
    "event_title": {"data_type": "text"},
    "event_start_time": {"data_type": "timestamp", "timezone": False},
    "event_finished_time": {"data_type": "timestamp", "timezone": False},
    "event_game_id": {"data_type": "text"},
    "event_ended": {"data_type": "bool"},
