...
def polymarket_us_midterms_2026_raw_markets(
    ...
    yield from asset_helpers._run_raw_markets(
        ...
        config,
        dlt,
        asset_name="polymarket_us_midterms_2026_raw_markets",
        scope_name=POLYMARKET_US_MIDTERMS_2026_SCOPE_NAME,
        discovery_mode="targeted",
        source_fn=polymarket_us_midterms_2026_markets_source,
...
def polymarket_us_midterms_2026_raw_markets_snapshot(
    ...
    return asset_helpers._materialize_raw_markets_snapshot(
        context,
        config,
        asset_name="polymarket_us_midterms_2026_raw_markets_snapshot",
        scope_name=POLYMARKET_US_MIDTERMS_2026_SCOPE_NAME,
