...
MINUTE_ODDS_LIVE_SMOKE_ENV := DUCKDB_NAME="$(MINUTE_ODDS_LIVE_SMOKE_DUCKDB_PATH)" DUCKDB_PATH="$(MINUTE_ODDS_LIVE_SMOKE_DUCKDB_PATH)" POLYMARKET_WC2026_MINUTE_ODDS_REFRESH_CATALOG="$(MINUTE_ODDS_LIVE_SMOKE_REFRESH_CATALOG)" POLYMARKET_WC2026_MINUTE_ODDS_REFRESH_MATCH=true POLYMARKET_WC2026_MINUTE_ODDS_REFRESH_FUTURES=true
